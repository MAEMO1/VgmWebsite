      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="bg-white rounded-2xl shadow-md border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Geen nieuws</h3>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {newsPosts.slice(0, 3).map((news: any) => (
            <div key={news.id} className="bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              {/* News Image */}
              <CardImage
