...
export default function MosqueDetailClient({ mosqueId }: MosqueDetailClientProps) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Moskee niet gevonden</h2>
          <p className="text-gray-600 mb-4">De gevraagde moskee kon niet worden geladen.</p>
          <button 
